...
public class MainActivity extends Activity {
    ...
    /**
     * Onclick method called when the Power button is presse
     **/
...
//Questions:
/*
What is the difference between step over & step into?
    - Step Into: goes line by line to execute
    each line to debug the code which includes the function call

    - Step Over: Skips the function call and executes the next
    Essentially executes the function afterwards as one step

How does each part of the debugger view change when you step into a new method?
    - When you set breakpoints the view changes by going to each execution / or
    skips an execution based on how you try to debug your code. The view shows
    the the current line it goes to on the actual code as well as the variables used
